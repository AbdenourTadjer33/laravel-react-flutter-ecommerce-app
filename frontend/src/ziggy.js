const Ziggy = {
  ...
  routes: {
    ...
    "admin.brand.create": { uri: "admin/brands/create", methods: ["GET", "HEAD"] },
    "admin.brand.store": { uri: "admin/brands", methods: ["POST"] },
    "admin.brand.show": { uri: "admin/brands/{brand}", methods: ["GET", "HEAD"], parameters: ["brand"] },
    "admin.brand.edit": {
    ...
    "admin.product.index": { uri: "admin/products", methods: ["GET", "HEAD"] },
    "admin.product.create": { uri: "admin/products/create", methods: ["GET", "HEAD"] },
    "admin.product.store": { uri: "admin/products", methods: ["POST"] },
    "admin.product.show": { uri: "admin/products/{product}", methods: ["GET", "HEAD"], parameters: ["product"] },
    "admin.product.edit": {
    ...
    "admin.order.create": { uri: "admin/orders/create", methods: ["GET", "HEAD"] },
    "admin.order.store": { uri: "admin/orders", methods: ["POST"] },
    "admin.order.show": { uri: "admin/orders/{order}", methods: ["GET", "HEAD"], parameters: ["order"] },
    "admin.order.edit": { uri: "admin/orders/{order}/edit", methods: ["GET", "HEAD"], parameters: ["order"] },
    "admin.order.update": { uri: "admin/orders/{order}", methods: ["PUT", "PATCH"], parameters: ["order"] },
    "admin.order.destroy": { uri: "admin/orders/{order}", methods: ["DELETE"], parameters: ["order"] },
    ...
    "api.brand.index": { uri: "api/brands", methods: ["GET", "HEAD"] },
    "api.brand.show": { uri: "api/brands/{brand}", methods: ["GET", "HEAD"], parameters: ["brand"] },
    "api.order.store": { uri: "api/orders", methods: ["POST"] },
    "api.order.show": { uri: "api/orders/{order}", methods: ["GET", "HEAD"], parameters: ["order"] },
    "api.cart": { uri: "api/cart", methods: ["POST"] },
  },
};
